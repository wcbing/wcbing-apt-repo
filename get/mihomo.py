...
name = "mihomo"
# https://github.com/MetaCubeX/mihomo/releases/download/v1.18.6/mihomo-linux-amd64-compatible-v1.18.6.deb
x64_deb_url = (
    release_url + "/download/" + vversion + "/" + name + "-linux-amd64-compatible-" + vversion + ".deb"
)
